...
public class Main {
  ...
  public static void main(String[] args) {
    ...
    while (true) {
      ...
      int command = takeCommandAndCheck(5);
      switch (command) {
        ...
        case 1 -> {
          ...
          switch (command) {
            ...
            case 1 -> {
              ...
              System.out.println(
                  "Ваше слово: " + wordKey + ". Введите его значение на русском языке:");
              String word = isInLine();
              while (isRuWord(word)) {
        ...
        case 2 -> {
          ...
          switch (command) {
            ...
            case 1 -> {
              ...
              String dWord = dictionary.getDictionaryKey(Integer.parseInt(wordKey));
                if (dWord != null) {
            ...
            case 2 -> {
              ...
              String dWord = dictionary.getDictionaryKey(wordKey);
                if (dWord != null) {
                    System.out.println("Ваше слово :" + dWord);
                } else {
                    System.out.println("Слово с таким ключем не найдено!\n");
        ...
        case 3 -> {
          ...
          switch (command) {
            ...
            case 1 -> {
              ...
              String wordRu = dictionary.getDictionaryKey(wordKey);
                if (dictionary.removeWordDictionary(Integer.parseInt(wordKey))) {
                    System.out.println(
                        "Слово : " + wordKey + "с значением : " + wordRu + "Удалено.");
                } else {
  ...
  public static byte takeCommandAndCheck(int commands) {
    byte command;
    String input_command_string = isInLine();
    while (true) {
      if (isDigit(input_command_string)) {
        ...
        if (command > 0 && command <= commands) {
          ...
          System.out.println(
              "Число не является командой. Допустимы номера команд от 1 до " + commands);
          input_command_string = isInLine();
        }
      } else {
