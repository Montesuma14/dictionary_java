...
public class Dictionary {
    ...
    //Добавление слова в словарь, обновление файла словаря (Интовый словарь)
    ...
    //Добавление слова в словарь, обновление файла словаря (Латинский словарь словарь)
    ...
    //Вывод конкретного слова по ключу(Интовый словарь)
    public String getDictionary(int key){
        return dictionaryInt.get(key);
    }
    //Вывод конкретного слова по ключу(Латинский словарь)
    public String getDictionary(String key){
        return dictionaryStr.get(key);
    }


    //Удаление слова из словоря и обновление файла (Интовый словарь словарь)
